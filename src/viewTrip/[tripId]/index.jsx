    ...
    if (docSnap.exists()) {
      ...
      Object.entries(raw).forEach(([date, activities]) => {
        newList[date] = activities.map((act) => {
          const [time, period] = act.time?.split(" ") || ["01:00", "AM"];
                            ...
                            {hasFullDetails ? (
                              <div className="flex-1">
                                ...
                                <p>
                                  ...
                                  {
                                    act.timings /* make sure this no longer carries “AM/PM” */
                                  }
                                </p>
                                <p>
                                  <strong>Pricing:</strong>{" "}
                                  {typeof act.pricing === "number" ||
                                  !isNaN(act.pricing)
        ...
        {isChatOpen && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-40">
            <div
              ...
              style={{
                backgroundImage: "url('/backgrounds/durga_bg.jpg')",
                backgroundSize: "cover",
                backgroundPosition: "center",
                backgroundRepeat: "no-repeat",
              }}
